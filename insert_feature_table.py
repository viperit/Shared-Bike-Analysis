...
def insert_part12_1(readPath, outPath):
    ...
    with open('./data/temp/feature_table/cur_hour_start_to_end_end_ratio', 'rb') as f:
        cur_hour_start_to_end_end_ratio = pickle.load(f)
    ...
    with open(outPath, 'w', newline='') as csv_file:
        ...
        for row in csv_reader:
            ...
            row.append(cur_hour_start_to_end_end_ratio.get(start, {}).get(end, {}).get(hour, 0))
            ...
            row.append(cur_hour_start_to_end_end_ratio.get(end, {}).get(start, {}).get(hour, 0))
...
def insert_part12_2(readPath, outPath):
    ...
    with open('./data/temp/feature_table/cur_hour_start_to_end_cur_hour_end_ratio', 'rb') as f:
        cur_hour_start_to_end_cur_hour_end_ratio = pickle.load(f)
    ...
    with open(outPath, 'w', newline='') as csv_file:
        ...
        for row in csv_reader:
            ...
            row.append(cur_hour_start_to_end_cur_hour_end_ratio.get(start, {}).get(end, {}).get(hour, 0))

            # 终点到起点
            row.append(cur_hour_start_to_end_cur_hour_start_ratio.get(end, {}).get(start, {}).get(hour, 0))
            row.append(cur_hour_start_to_end_cur_hour_end_ratio.get(end, {}).get(start, {}).get(hour, 0))
...
def insert_part12_3(readPath, outPath):
    ...
    with open('./data/temp/feature_table/cur_hour_start_geofly_to_end_start_geofly_ratio', 'rb') as f:
        cur_hour_start_geofly_to_end_start_geofly_ratio = pickle.load(f)

    with open('./data/temp/feature_table/cur_hour_start_geofly_to_end_end_ratio', 'rb') as f:
        cur_hour_start_geofly_to_end_end_ratio = pickle.load(f)
    ...
    with open(outPath, 'w', newline='') as csv_file:
        ...
        for row in csv_reader:
            ...
            row.append(cur_hour_start_geofly_to_end_start_geofly_ratio.get(start, {}).get(end, {}).get(hour, 0))
            row.append(cur_hour_start_geofly_to_end_end_ratio.get(start, {}).get(end, {}).get(hour, 0))
            ...
            row.append(cur_hour_start_geofly_to_end_start_geofly_ratio.get(end, {}).get(start, {}).get(hour, 0))
            row.append(cur_hour_start_geofly_to_end_end_ratio.get(end, {}).get(start, {}).get(hour, 0))
...
def insert_part12_4(readPath, outPath):
    ...
    with open('./data/temp/feature_table/cur_hour_start_geofly_to_end_cur_hour_end_ratio', 'rb') as f:
        cur_hour_start_geofly_to_end_cur_hour_end_ratio = pickle.load(f)
    ...
    with open(outPath, 'w', newline='') as csv_file:
        ...
        for row in csv_reader:
            ...
            # 起点geofly到终点
            row.append(cur_hour_start_geofly_to_end_cur_hour_start_geofly_ratio.get(start, {}).get(end, {}).get(hour, 0))
            row.append(cur_hour_start_geofly_to_end_cur_hour_end_ratio.get(start, {}).get(end, {}).get(hour, 0))

            # 终点geofly到起点
            row.append(cur_hour_start_geofly_to_end_cur_hour_start_geofly_ratio.get(end, {}).get(start, {}).get(hour, 0))
            row.append(cur_hour_start_geofly_to_end_cur_hour_end_ratio.get(end, {}).get(start, {}).get(hour, 0))
...
def insert_part12_5(readPath, outPath):
    ...
    with open('./data/temp/feature_table/cur_hour_start_to_end_geofly_end_geofly_ratio', 'rb') as f:
        cur_hour_start_to_end_geofly_end_geofly_ratio = pickle.load(f)
    ...
    with open(outPath, 'w', newline='') as csv_file:
        ...
        for row in csv_reader:
            ...
            row.append(cur_hour_start_to_end_geofly_end_geofly_ratio.get(start, {}).get(end, {}).get(hour, 0))
            ...
            row.append(cur_hour_start_to_end_geofly_end_geofly_ratio.get(end, {}).get(start, {}).get(hour, 0))
...
def insert_part12_6(readPath, outPath):
    ...
    with open('./data/temp/feature_table/cur_hour_start_to_end_geofly_cur_hour_end_geofly_ratio', 'rb') as f:
        cur_hour_start_to_end_geofly_cur_hour_end_geofly_ratio = pickle.load(f)
    ...
    with open(outPath, 'w', newline='') as csv_file:
        ...
        for row in csv_reader:
            ...
            row.append(cur_hour_start_to_end_geofly_cur_hour_end_geofly_ratio.get(start, {}).get(end, {}).get(hour, 0))

            # 终点到起点geofly
            row.append(cur_hour_start_to_end_geofly_cur_hour_start_ratio.get(end, {}).get(start, {}).get(hour, 0))
            row.append(cur_hour_start_to_end_geofly_cur_hour_end_geofly_ratio.get(end, {}).get(start, {}).get(hour, 0))
...
def insert_part12_9(readPath, outPath):
    ...
    with open(outPath, 'w', newline='') as csv_file:
        ...
        for row in csv_reader:
            ...
            row.append(cur_hour_start_geofly_to_end_geofly_cur_hour_start_geofly_ratio.get(start, {}).get(end, {}).get(hour, 0))

            # 终点geofly到起点geofly / 当前小时终点geofly总出发
            row.append(cur_hour_start_geofly_to_end_geofly_cur_hour_start_geofly_ratio.get(end, {}).get(start, {}).get(hour, 0))
...
def insert_part12_10(readPath, outPath):
    ...
    with open('./data/temp/feature_table/cur_hour_start_geofly_to_end_geofly_end_geofly_ratio', 'rb') as f:
        cur_hour_start_geofly_to_end_geofly_end_geofly_ratio = pickle.load(f)
    ...
    with open(outPath, 'w', newline='') as csv_file:
        ...
        for row in csv_reader:
            ...
            row.append(cur_hour_start_geofly_to_end_geofly_end_geofly_ratio.get(start, {}).get(end, {}).get(hour, 0))

            # 终点geofly到起点geofly / 起点geofly总到达
            row.append(cur_hour_start_geofly_to_end_geofly_end_geofly_ratio.get(end, {}).get(start, {}).get(hour, 0))
...
def insert_part12_11(readPath, outPath):
    ...
    with open('./data/temp/feature_table/cur_hour_start_geofly_to_end_geofly_cur_hour_end_geofly_ratio', 'rb') as f:
        cur_hour_start_geofly_to_end_geofly_cur_hour_end_geofly_ratio = pickle.load(f)
    ...
    with open(outPath, 'w', newline='') as csv_file:
        ...
        for row in csv_reader:
            ...
            row.append(cur_hour_start_geofly_to_end_geofly_cur_hour_end_geofly_ratio.get(start, {}).get(end, {}).get(hour, 0))

            # 终点geofly到起点geofly / 当前小时起点geofly总到达
            row.append(cur_hour_start_geofly_to_end_geofly_cur_hour_end_geofly_ratio.get(end, {}).get(start, {}).get(hour, 0))
